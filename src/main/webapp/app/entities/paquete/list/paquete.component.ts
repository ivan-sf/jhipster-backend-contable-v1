...
export class PaqueteComponent implements OnInit {
  ...
  trackId(index: number, item: IPaquete): number {
    return item.id!;
  }

  delete(paquete: IPaquete): void {
    const modalRef = this.modalService.open(PaqueteDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IPaquete[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
