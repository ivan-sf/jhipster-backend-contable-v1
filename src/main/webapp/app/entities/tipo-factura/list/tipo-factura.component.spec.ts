...
describe('TipoFactura Management Component', () => {
  let comp: TipoFacturaComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TipoFacturaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tipoFacturas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
