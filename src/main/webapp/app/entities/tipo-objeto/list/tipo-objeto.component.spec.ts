...
describe('TipoObjeto Management Component', () => {
  let comp: TipoObjetoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TipoObjetoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tipoObjetos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
