...
describe('Departamento routing resolve service', () => {
  ...
  let resultDepartamento: IDepartamento | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IDepartamento if id is not provided', () => {
      // GIVEN
      ...
      expect(resultDepartamento).toEqual(new Departamento());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Departamento })));
      mockActivatedRouteSnapshot.params = { id: 123 };
