...
export class LoteComponent implements OnInit {
  ...
  trackId(index: number, item: ILote): number {
    return item.id!;
  }

  delete(lote: ILote): void {
  ...
  protected onSuccess(data: ILote[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
