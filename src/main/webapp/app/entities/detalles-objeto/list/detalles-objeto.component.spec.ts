...
describe('DetallesObjeto Management Component', () => {
  let comp: DetallesObjetoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [DetallesObjetoComponent],
      providers: [
        Router,
        {
      ...
      .overrideTemplate(DetallesObjetoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.detallesObjetos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
