...
describe('Objeto Management Component', () => {
  let comp: ObjetoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ObjetoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.objetos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
