...
describe('Vencimiento Management Component', () => {
  let comp: VencimientoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(VencimientoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vencimientos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
