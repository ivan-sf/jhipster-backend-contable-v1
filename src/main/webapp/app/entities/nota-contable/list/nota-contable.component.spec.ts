...
import { NotaContableComponent } from './nota-contable.component';

describe('NotaContable Management Component', () => {
  let comp: NotaContableComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(NotaContableComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.notaContables?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
