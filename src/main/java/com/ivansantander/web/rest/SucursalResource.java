...
/**
 * REST controller for managing {@link com.ivansantander.domain.Sucursal}.
 */
@RestController
@RequestMapping("/api")
public class SucursalResource {
    ...
    public ResponseEntity<List<Sucursal>> getAllSucursals(Pageable pageable) {
        log.debug("REST request to get a page of Sucursals");
        Page<Sucursal> page = sucursalService.findAll(pageable);
