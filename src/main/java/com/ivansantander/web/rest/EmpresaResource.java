...
/**
 * REST controller for managing {@link com.ivansantander.domain.Empresa}.
 */
@RestController
@RequestMapping("/api")
public class EmpresaResource {
    ...
    public ResponseEntity<List<Empresa>> getAllEmpresas(
        ...
        Page<Empresa> page;
        if (eagerload) {
            page = empresaService.findAllWithEagerRelationships(pageable);
        } else {
            page = empresaService.findAll(pageable);
        }
