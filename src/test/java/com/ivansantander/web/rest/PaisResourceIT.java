...
class PaisResourceIT {
    ...
    public static Pais createEntity(EntityManager em) {
        Pais pais = new Pais().nombre(DEFAULT_NOMBRE).codigoDIAN(DEFAULT_CODIGO_DIAN);
        return pais;
    }
    ...
    public static Pais createUpdatedEntity(EntityManager em) {
        Pais pais = new Pais().nombre(UPDATED_NOMBRE).codigoDIAN(UPDATED_CODIGO_DIAN);
        return pais;
    }
    ...
    void createPais() throws Exception {
        ...
        assertThat(testPais.getCodigoDIAN()).isEqualTo(DEFAULT_CODIGO_DIAN);
    }
    ...
    void putNewPais() throws Exception {
        ...
        updatedPais.nombre(UPDATED_NOMBRE).codigoDIAN(UPDATED_CODIGO_DIAN);
        ...
        assertThat(testPais.getCodigoDIAN()).isEqualTo(UPDATED_CODIGO_DIAN);
    }
    ...
    void partialUpdatePaisWithPatch() throws Exception {
        ...
        partialUpdatedPais.nombre(UPDATED_NOMBRE).codigoDIAN(UPDATED_CODIGO_DIAN);
