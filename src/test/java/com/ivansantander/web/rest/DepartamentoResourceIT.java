...
class DepartamentoResourceIT {
    ...
    public static Departamento createEntity(EntityManager em) {
        Departamento departamento = new Departamento().nombre(DEFAULT_NOMBRE).codigoDIAN(DEFAULT_CODIGO_DIAN);
        return departamento;
    }
    ...
    public static Departamento createUpdatedEntity(EntityManager em) {
        Departamento departamento = new Departamento().nombre(UPDATED_NOMBRE).codigoDIAN(UPDATED_CODIGO_DIAN);
        return departamento;
    }
    ...
    void createDepartamento() throws Exception {
        ...
        assertThat(testDepartamento.getCodigoDIAN()).isEqualTo(DEFAULT_CODIGO_DIAN);
    }
    ...
    void putNewDepartamento() throws Exception {
        ...
        updatedDepartamento.nombre(UPDATED_NOMBRE).codigoDIAN(UPDATED_CODIGO_DIAN);
        ...
        assertThat(testDepartamento.getCodigoDIAN()).isEqualTo(UPDATED_CODIGO_DIAN);
    }
    ...
    void partialUpdateDepartamentoWithPatch() throws Exception {
        ...
        partialUpdatedDepartamento.nombre(UPDATED_NOMBRE).codigoDIAN(UPDATED_CODIGO_DIAN);
